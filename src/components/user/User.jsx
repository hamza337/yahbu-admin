      ...
      <table class="w-full text-left table-auto min-w-max">
        ...
        <tbody>
          <tr class="hover:bg-slate-50 border-b border-slate-200">
            ...
            <td class="p-4 py-5">
              <p class="text-sm text-slate-500">woop@yahbu.com</p>
            </td>
            <td class="p-4 py-5">
          ...
          <tr class="hover:bg-slate-50 border-b border-slate-200">
            ...
            <td class="p-4 py-5">
              <p class="text-sm text-slate-500">cmh@yahbu.com</p>
            </td>
            <td class="p-4 py-5">
              <p class="text-sm text-slate-500">Admin</p>
            </td>
          ...
          <tr class="hover:bg-slate-50 border-b border-slate-200">
            ...
            <td class="p-4 py-5">
              <p class="text-sm text-slate-500">xyz@yahbu.com</p>
            </td>
            <td class="p-4 py-5">
              <p class="text-sm text-slate-500">Admin</p>
            </td>
          ...
          <tr class="hover:bg-slate-50 border-b border-slate-200">
            ...
            <td class="p-4 py-5">
              <p class="text-sm text-slate-500">abc@yahbu.com</p>
            </td>
            <td class="p-4 py-5">
              <p class="text-sm text-slate-500">Admin</p>
            </td>
